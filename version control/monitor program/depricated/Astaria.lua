...
-- gate addresses
local gateTable = {
    {3,6,1,24,22,30,10,31,0},       --overworld
    ...
    {6,10,25,11,30,15,28,4,0},      --Mysts's colony
...
function Dial(address) --borrowed code to dial the gate. credit: Povstalec
    ...
    if gateType == "sgjourney:milky_way_stargate" then
        ...
        do
            ...
            sleep(0)    --Pegasus gates dont like wait times
